...
describe("curried", () => {
  it("returns a usable curried function", () => {
  ...
  it("provides named curried and partial functions", () => {
    const StandardAdd = (a, b, c) => a + b + c;
    const CurriedAdd = curried(StandardAdd);
...
describe("pipe", () => {
  it("pipes argument through curried functions", async () => {
    const StandardAdd = (a, b, c) => a + b + c;
    const CurriedAdd = curried(StandardAdd);
  ...
  it("pipes promise argument through curried functions", async () => {
    const promise = (n) =>
      new Promise((resolve) => {
  ...
  it("pipes argument through curried async functions", async () => {
    const StandardAdd = (a, b) => a + b;
  ...
  it("pipes curried functions together", () => {
    const StandardAdd = (a, b, c) => a + b + c;
    const CurriedAdd = curried(StandardAdd);
  ...
  it("pipes async functions together", async () => {
    const StandardAdd = (a, b) => a + b;
    const AsyncAdd = (a, b) => Promise.resolve(a + b);
    const CurriedAsyncAdd = (a) => (b) =>
      new Promise((resolve) => {
  ...
  test("provides meaningful error messages for manually curried insufficent arity problems", () => {
    const StandardAdd3 = (a, b, c) => a + b + c;
